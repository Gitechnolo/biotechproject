...
const customPronunciations={'CRISPR':'Clustered Regularly Interspaced Short Palindromic Repeats','epigenetica':'Epi-jen-etica','plasmide':'Plaz-mi-de','mitocondri':'Mi-to-con-dri','lisosoma':'Li-so-so-ma','miochine':'Mi-o-ki-ne','sinaptogenesi':'Si-na-to-jen-e-si','epigenetici':'E-pi-je-ne-ti-ci','ATP':'Adenosina trifosfato','DNA':'Acido desossiribonucleico','RNA':'Acido ribonucleico','cellula':'Chel-loo-la','tegumento':'Te-gu-men-to','cheratinociti':'Ke-ra-ti-no-chi-ti','melanociti':'Me-la-no-chi-ti','infiammazione':'In-fia-mma-zio-ne','neurotrofici':'Neu-ro-tro-fi-ci','microbiota':'Mi-cro-bi-o-ta'};const utterance=new SpeechSynthesisUtterance(customPronunciations[term]||term);const langMap={'italiano':'it-IT','inglese':'en-US'};utterance.lang=langMap[language]||'it-IT';utterance.rate=0.8;utterance.pitch=1;utterance.volume=1;const announcement=document.getElementById('sr-announcement');if(announcement){announcement.textContent=`Lettura avviata: ${term}.`;setTimeout(()=>announcement.textContent='',1000)}
console.log(`Pronuncia attivata: ${term} (${language})`);speechSynthesis.speak(utterance)}
