...
const preloaded=document.querySelector(`[rel="preload"][as="style"]`);if(preloaded){preloaded.onload=()=>{preloaded.rel='stylesheet';const mainContent=document.getElementById('main-content');if(mainContent){mainContent.style.opacity='1'}}}
if(preloaded&&preloaded.sheet){preloaded.rel='stylesheet';const mainContent=document.getElementById('main-content');if(mainContent){mainContent.style.opacity='1'}}