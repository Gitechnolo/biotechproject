function QRedshift(){if(document.body.classList.contains('qredshift-active'))return;const hour=new Date().getHours();let filter;if(hour>=7&&hour<19){filter='sepia(0.2) hue-rotate(0deg) brightness(1)'}else{filter='sepia(0.6) hue-rotate(-35deg) brightness(0.9)'}
